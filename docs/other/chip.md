...
可以想到 指令集是一个约定俗成的东西 用的人多了 这个指令集才值钱
...
### 第1.5代 CSP Chipe-Size Package

上面的工艺的基座过于厚重 于是在这里就替换为基板

### 第2代 flip chip 倒装封装

掐面两种方案 芯片不能批量化操作

所以提出了把芯片倒置 这样在就可以批量操作测试

从而增加效率

当然在这之中 还需要利用一个dump工艺

### 第3代 Info

当芯片越做越小 放引脚的地方就越来越小了 于是提出这个方案
