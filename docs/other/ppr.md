...
首先我们应该对[什么是 PageRank](/other/pageranks.md)有了一定概念 没有的话请点 👈
...
- 举个栗子, 在选 Top-3 的时候
  ...
  `\begin{equation}\pi(s,v_1)=0.45 ,\pi(s,v_2)=0.2, \pi(s,v_3)=0.18, \pi(s,v_4)=0.17, \epsilon=0.1, \delta=0.01\end{equation}`
