...
echo "累计访问量:" > log/pv
num=`awk '{if($9==200&&$7~/pv.txt/&&$0!~/bot/&&($0!~/spider/||$0~/other\/spider.html/)&&$0!~/php/&&$0!~/taishan/&&$6~/GET/&&$0!~/Verification/&&$0!~/"-" "-"/&&$0!~/[gG]o/&&$0!~/[pP]ython/&&$0!~/curl/&&$0!~/localhost/&&$0!~/Baiduspider/){print $0}}' $logpath|sort | uniq -c | wc -l`
