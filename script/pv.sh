...
echo "累计访问量:" > log/pv
num=`awk '{if($9==200&&$7~/pv.txt/&&$0!~/bot/&&$0!~/spider/&&$0!~/php/&&$0!~/taishan/&&$6~/GET/&&$0!~/Verification/&&$0!~/"-" "-"/&&$0!~/[gG]o/&&$0!~/[pP]ython/&&$0!~/curl/){print $0}}' $logpath|sort | uniq -c | wc -l`
...
then
    ...
    num=`awk 'NR==FNR {a[$2]=$0} NR!=FNR {if(FNR>1&&$12!="\"Chrome/57\""&&!($1 in a)&&($9!=200||$0~/bot/||$0~/spider/||$0~/php/||$0~/taishan/||$6!~/GET/||$0~/Verification/||$0~/"-" "-"/||$0~/[gG]o/||$0~/[pP]ython/||$0~/curl/))print $0}' log/user $logpath|sort | uniq -c | wc -l`
